...
class Box2DDebugDraw : public QQuickPaintedItem
{
    ...
    Q_PROPERTY(DebugShow debugShow READ debugShow WRITE setDebugShow NOTIFY debugShowChanged)
...
public:
    ...
    DebugShow debugShow() const;
    void setDebugShow(DebugShow _debugShow);
